package java8.leccion14.DateApi;

/**
 * @author Jorge Luis Pérez Canto
 * @date 19/12/2020 01:02
 */
...
public class App {
    ...
    public void periodoEntreFechas(int version) {
        if (version == 7) {
            ...
            System.out.println("Han transcurrido " + periodo.getYears() + " años y "+ periodo.getMonths() + " meses y " + periodo.getDays() + " dias, desde " + nacimiento + " hasta " + actual);
        }
    }
    ...
    public void convertir(int version) throws ParseException {
        if (version == 7) {
            ...
            String fechaConvertida2 = formateador.format(fechaActual);
            System.out.println(fechaConvertida2);
        } else if (version == 8) {
            String fecha = "21/01/1991";
